...
//   console.log(await browser.storage.local.get("bundlePlans"));

//   const { bundlePlans } = await browser.storage.local.get("bundlePlans");
  
//   const isBundleAvailableInCountry = bundlePlans.BUNDLE_PLANS.available_in_country;
